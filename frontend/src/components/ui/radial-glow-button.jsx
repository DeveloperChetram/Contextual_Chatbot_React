  ...
  return (
    <div className="relative inline-block">
      <style>{`
        ...
        @property --rg-color-1 { syntax: '<color>'; initial-value: #004474ff; inherits: false; }
        @property --rg-color-2 { syntax: '<color>'; initial-value: #0d6dffff; inherits: false; }
        @property --rg-color-3 { syntax: '<color>'; initial-value: #3ae8ffff; inherits: false; }
